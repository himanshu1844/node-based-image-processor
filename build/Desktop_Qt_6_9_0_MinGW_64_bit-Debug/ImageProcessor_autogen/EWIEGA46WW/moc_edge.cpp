...
namespace {
struct qt_meta_tag_ZN4EdgeE_t {};
} // unnamed namespace

template <> constexpr inline auto Edge::qt_create_metaobjectdata<qt_meta_tag_ZN4EdgeE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Edge, qt_meta_tag_ZN4EdgeE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Edge::staticMetaObject = { {
    QMetaObject::SuperData::link<NodeDelegateModel::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4EdgeE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4EdgeE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN4EdgeE_t>.metaTypes,
    nullptr
} };
...
void *Edge::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4EdgeE_t>.strings))
